...
class F1 {
    ...
    public static void main(String[] args) {
        ...
        Employee emp = new Employee("farhan" , 40);//<-key
...
/*OUTPUT:list ko Name k ascending order m sort krne k baad farhan - 40 ,Search index -3 pe aaya.
D:\javaprac\37_collection_framework\13_class_Collections>java F1
...
/*OUTPUT:list ko Name k descending order m sort krne k baad farhan - 40 ,Search index -5 pe aaya.
D:\javaprac\37_collection_framework\13_class_Collections>java F1
Before sort list is: [manoj - 52, geet - 23, balram - 19, om - 47, deepak - 62, yamraj - 32]
After sort list is: [yamraj - 32, om - 47, manoj - 52, geet - 23, deepak - 62, balram - 19]
-5 */

/*OUTPUT:list ko Age k ascending order m sort krne k baad farhan - 40 ,Search index -4 pe aaya.
D:\javaprac\37_collection_framework\13_class_Collections>java F1
Before sort list is: [manoj - 52, geet - 23, balram - 19, om - 47, deepak - 62, yamraj - 32]
After sort list is: [balram - 19, geet - 23, yamraj - 32, om - 47, manoj - 52, deepak - 62]
-4 */

/*OUTPUT:list ko Age k descending order m sort krne k baad farhan - 40 ,Search index -4 pe aaya.
D:\javaprac\37_collection_framework\13_class_Collections>java F1
Before sort list is: [manoj - 52, geet - 23, balram - 19, om - 47, deepak - 62, yamraj - 32]
